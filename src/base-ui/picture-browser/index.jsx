...
import { BrowserWarpper } from './style'
import IconTriangleTop from '@/assest/svg/icon_triagger_top'
import IconTriangleBottom from '@/assest/svg/icon_traigger_bottom'
...
const PictureBrowser = memo((props) => {
  ...
  return (
    <BrowserWarpper isNext={isNext}>
      <div className='top'>
        <span className='close-btn' onClick={closeBtnClickHandle}>
          <IconClose/>
        </span>
      </div>
      <div className='slider'>  {/** 滑动图片，轮播图 */}
        <div className='control'> {/**控制左右 */}
